...
tree=read.nexus("D:/Github_projects/Mars-shape/Data/Raw/Mitchell_pruned_tree.nex")
...
names(tree_use$tip.labels[NUMBER] <- "New_Species")
names(tree_use$tip.label[1] <- "Lestoros_inca")


namecheck=name.check(tree_use,dimnames(Data)[[3]])

Matchtest=match(tree[1]$tree_1$tip.label,dimnames(Data)[[3]])

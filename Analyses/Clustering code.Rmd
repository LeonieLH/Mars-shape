...
#these work in individually but not by running th
...
Random_trees <- rmtree(1000, length(tree_synch$tip.label), rooted = TRUE, tip.label = tree_synch$tip.label, br = runif)

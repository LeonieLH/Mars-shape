...
#ind.coords_gpa <- gpagen (ind.coords) #double-sliding the configurations seems dubious to me.
...
#NOTE THAT THIS CURRENTLY USES THE CONSENSUS CONFIGURATION OF THE DATASET WITH ALL SPECIMENS! I NEED TO FIX THIS ABOVE BUT I ALSO THINK THAT LEONIE FORGOT OT RE-RUN THE GPA ON THE COLLAPSED DATASET
```{r, echo=FALSE}


#THE BELOW USES THE COORDINATES OF THE DATASET WITH SPECIES AVERAGED; CSIZE WITH SPECIES AVERAGED;AND CONSENSUS CONFIG OF THE COORDINAGES WITH THE SPECIES AVERAGED. BUT THIS MEANS THE DATASET WITH THE SPECIES AVERAGED HAD TO GO THROUGH ANOTHER GPA, WHICH I BELIEVE IS CORRECT BUT SHOULD BE DOUBLE CHECKED
...
save(Data,GPA_Allmean,GPA_Basimean,GPA_Restmean, Allom_all_plus_consensus,Allom_basi_plus_consensus,Allom_rest_plus_consensus,allom_res_all,allom_res_basi, allom_res_rest, speclist,part.gp, tree_synch, file = "../Data/Processed/processed_data_for_mars_phylo_shape.rda")

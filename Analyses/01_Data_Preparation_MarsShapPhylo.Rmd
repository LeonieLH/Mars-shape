...
speclist <- read.csv("../Data/Raw/Species_classifier.csv")
...
#Wombat
plotRefToTarget(GPA_AllSpecimens$coords[,,62],GPA_AllSpecimens$coords[,,Meanspec], method = "vector" )

#Notoryctes 

plotRefToTarget(GPA_AllSpecimens$coords[,,36],GPA_AllSpecimens$coords[,,Meanspec], method = "vector" )

#a quick way of visualising all 

#No. 8 is an error

for (i in c(1:10)){
  
  plotRefToTarget(GPA_AllSpecimens$coords[,,i],GPA_AllSpecimens$coords[,,Meanspec], method = "vector", main = dimnames(GPA_AllSpecimens$coords)[[3]][i])
  rgl.open()
